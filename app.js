...
/**
 * Check Fortishield app version
 * Using: Header: "fortishield-app-version: X.Y.Z"
 */
app.use(function(req, res, next) {
    var go_next = true;
    var app_version_header = req.get('fortishield-app-version');
