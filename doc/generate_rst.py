...
hardcoded_items = {
        ...
        # GET /agents/outdated
        'GetOutdatedAgents' : {"error":0,"data":{"totalItems":2,"items":[{"version": "Fortishield v3.0.0","id": "003","name": "main_database"},{"version": "Fortishield v3.0.0","id": "004","name": "dmz002"}]}},
...
if __name__ == "__main__":
    ...
    try:
        # fortishield-api: apidoc -i ../ -o ./build/html -c . -f js -e node_modules
