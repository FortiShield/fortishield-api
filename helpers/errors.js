...
errors['622'] = 'Param not valid. Review queries documentation: https://documentation.fortishield.com/current/user-manual/api/queries.html'
...
errors['801'] = "Wrong format for 'fortishield-app-version' header. Expected format: 'X.Y.Z'";
errors['802'] = "Invalid 'fortishield-app-version' header";
errors['803'] = "Fortishield API is only available for master nodes";
