 ...
 * @apiParam {String} [version] Fortishield version.
 ...
 *
 * @apiParam {Number} agent_id Agent unique ID.
 * @apiParam {String} file_path Path to the WPK file. The file must be on a folder on the Fortishield's installation directory (by default, ``/var/ossec``).
