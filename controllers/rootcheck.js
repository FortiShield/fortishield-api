 ...
 *
 *
 * @apiDescription Runs syscheck and rootcheck on all agents (Fortishield launches both processes simultaneously).
 *
 * @apiExample {curl} Example usage*:
 ...
 * @apiParam {Number} agent_id Agent ID.
 *
 * @apiDescription Runs syscheck and rootcheck on a specified agent (Fortishield launches both processes simultaneously)
 *
 * @apiExample {curl} Example usage:
