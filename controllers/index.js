...
errors = require('../fortishield-api/helpers/errors');
filter = require('../fortishield-api/helpers/filters');
execute = require('../fortishield-api/helpers/execute');
templates = require('../fortishield-api/helpers/request_templates');
apicache  = require('apicache');
cache     = apicache.middleware;
fortishield_control = api_path + "/models/fortishield-api.py";
...
router.use('/syscheck', require('../fortishield-api/controllers/syscheck'));
router.use('/rootcheck', require('./rootcheck'));
router.use('/sca', require('../fortishield-api/controllers/security_configuration_assessment'));
...
router.use('/syscollector', require('../fortishield-api/controllers/syscollector'));
router.use('/ciscat', require('./ciscat'));
router.use('/active-response', require('./active_response'));
router.use('/lists', require('./lists'));
router.use('/summary', require('../fortishield-api/controllers/summary'));
...
router.get('/',function(req, res) {
    ...
    data = { 'msg': "Welcome to Fortishield HIDS API", 'api_version': "v" + info_package.version, 'hostname': os.hostname(), 'timestamp': new Date().toString()}
