...
/**
 * @api {put} /manager/restart Restart Fortishield manager
 * @apiName PutRestartManager
 * @apiGroup Restart
 *
 * @apiDescription Restarts Fortishield Manager.
 *
 * @apiExample {curl} Example usage*:
...
/**
 * @api {get} /manager/configuration/validation Check Fortishield configuration
 * @apiName GetManagerConfiguration
 * @apiGroup Files
 *
