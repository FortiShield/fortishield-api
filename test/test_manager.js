 ...
 * Copyright (C) 2015-2016 Fortishield, Inc.All rights reserved.
 * Fortishield.com
 *
...
describe('Manager', function() {
        ...
        it('Request', function(done) {
            ...
            .end(function(err,res){
                ...
                res.body.data.should.have.properties(['ossec-agentlessd', 'ossec-analysisd', 'ossec-authd', 'ossec-csyslogd', 'ossec-dbd', 'ossec-monitord',
                                                      ...
                                                      'ossec-reportd', 'ossec-syscheckd', 'fortishield-clusterd', 'fortishield-modulesd', 'fortishield-db']);
                done();
            });
        });
    ...
    describe('GET/manager/files', function() {
        ...
        it('Request decoders (global)', function(done) {
            request(common.url)
            .get("/manager/files?path=ruleset/decoders/0005-fortishield_decoders.xml")
            .auth(common.credentials.user, common.credentials.password)
            .expect("Content-type",/json/)
            .expect(200)
            .end(function(err,res){
        ...
        it('Request wrong path 3', function(done) {
            request(common.url)
            .get("/manager/files?path=./framework/fortishield/agent.py")
            .auth(common.credentials.user, common.credentials.password)
            .expect("Content-type",/json/)
            .expect(400)
            .end(function(err,res){
    ...
    describe('GET/manager/config/:component/:configuration', function () {
		...
		it('Request-Wmodules-Wmodules', function(done) {
            ...
            .end(function(err,res){
                ...
                module_list = ['cis-cat', 'database', 'open-scap', 'osquery', 'sca', 'syscollector', 'vulnerability-detector', 'fortishield_control', 'fortishield_download']
