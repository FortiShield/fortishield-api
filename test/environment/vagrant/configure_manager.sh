...
apt-get update
apt-get install fortishield-manager -y
...
cd ${fortishield_api_folder}
${fortishield_api_folder}/install_api.sh
...
then
    ...
    fortishield_database.sync_syscheck=1
EOT
