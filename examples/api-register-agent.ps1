...
#  Copyright (C) 2017 Fortishield, Inc. All rights reserved.
#  Fortishield.com
#
...
try{
    ...
    Write-Output "The Fortishield manager is contactable via the API, the response is: `n $($testresponse)"
    }catch{
...
Add-Content $config "`n<ossec_config>   <client>    <server>  <address>$($fortishield_manager)</address> </server>   </client> </ossec_config>"
